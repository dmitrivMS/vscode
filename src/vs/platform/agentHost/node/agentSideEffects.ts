...
export class AgentSideEffects extends Disposable {
	...
	private _handleSubagentStarted(
		...
		const { parentTurnId, parentClientContext, correlatedParentTurnId } = this._getSubagentParentTurnTelemetryContext(immediateParentChatUri, contentChatUri);
		...
		if (agent) {
			this._turnTracker.turnStarted(agent.id, subagentChatUri, turnId, undefined, undefined, 'default', undefined, undefined, parentClientContext, correlatedParentTurnId);
	...
	private _resumeSubagentSession(parentChatURI: ProtocolURI, toolCallId: string, message: Message | undefined, immediateParentChatURI?: ProtocolURI): void {
		...
		const { parentClientContext, correlatedParentTurnId } = this._getSubagentParentTurnTelemetryContext(correlatedParentChatUri, parentChatUri);
		...
		if (agent) {
			this._turnTracker.turnStarted(agent.id, subagent.chatUri, turnId, undefined, undefined, 'default', undefined, undefined, parentClientContext, correlatedParentTurnId);
